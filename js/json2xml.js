...
/* Changes made by Ohmage Team to support Ohmage campaigns */

/*
USAGE: 
MAKE SURE TO USE parseXml(xmlstring) BEFORE PASSING INTO xml2json!
               ...
               if (hasElementChild) {
                  if (textChild < 2 && cdataChild < 2) { // structured element with evtl. a single text or/and cdata node ..
                     ...
                     for (var n=xml.firstChild; n; n=n.nextSibling) {
                        if (surveyItem) {    // hack for Ohmage
                           o[""][o[""].length] = {};
                           o[""][o[""].length - 1][n.nodeName] = X.toObj(n);
                        }
                           ...
                           if (n.nodeName == "contentList") {  // hack for Ohmage
                              o[n.nodeName] = X.toObj(n, true)
                           }
                           else {
